...
@interface PictrueViewController ()

@end

@implementation PictrueViewController
@synthesize menuBtnDelegate;

- (void)viewDidLoad
{
    [super viewDidLoad];
    [self initNaviWithTitle:@"图片"];
...
-(void)initComponents
{
    ...
    bigview.image = [UIImage imageNamed:@"example3.jpg"];
